...
public class UpdateTrainDelayNotification : BaseNotification
{
                      public override void ProcessNotification(IEnumerable<AutomationNotification> automationNotifications, PushNotification pushNotification)
    {
        try
        {
            ...
            if (delayTrain != null)
            {
                base.NotificationEvents.Add(new NotificationEvent
                {
                    ...
                    NotificationTypeId = (int)NotificationTypes.UpdateTrainDelay,
        ...
        {
            throw new NotificationException("Notifications - Create notification message - Update Train Delay", $"Push Notification Id: {pushNotification.Id}", ex);
        }
    }
